...
class GameWonFragment : Fragment() {
    ...
    private fun getShareIntent ():Intent
    {
        ...
        /*shareIntent.setType("text/plain")
                .putExtra(Intent.EXTRA_TEXT,getString(R.string.share_success_text,args.numCorrect,args.numOfQues))*/
        return ShareCompat.IntentBuilder.from(activity).setText(getString(R.string.share_success_text,args.numCorrect,args.numOfQues))
                .setType("text/plain")
                .intent

    }
    private fun shareScuccess()
    {
